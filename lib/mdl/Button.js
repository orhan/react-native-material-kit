...
class Button extends Component {
  ...
  render() {
    ...
    if (this.props.fab) {
      ...
      if (this.props.fabSize) {
        fabStyle.width = this.props.fabSize;
        fabStyle.height = this.props.fabSize;
        fabStyle.borderRadius = this.props.fabSize / 2;
      } else if (this.state.width > 0 || this.state.height > 0) {
