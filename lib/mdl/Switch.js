...
class Switch extends Component {
  ...
  _getBorderColor(theme) {
    const onColor = this.props.trackOnBorderColor || 'rgba(0, 0, 0, 0)';
    const offColor = this.props.trackOffBorderColor || 'rgba(0, 0, 0, 0)';
    return this.state.checked ? onColor : offColor;
  }
        ...
        >
          <View ref="track"  // the 'track' part
            style={{
              ...
              borderWidth: this.props.trackBorderWidth,
...
Switch.propTypes = {
  ...
  // The border color of the track (on)
  trackOnBorderColor: PropTypes.string,

  // The border color of the track (off)
  trackOffBorderColor: PropTypes.string,

  // The border width of the track
  trackBorderWidth: PropTypes.number,
